...
public class YouTubeSearchDefinition {
	...
	public void open_Chrome_browser_and_enter_url() throws IOException, InterruptedException {
		...
		System.setProperty("webdriver.chrome.driver","Q:\\Amit Kumar\\Amit_Automation\\Amit_Workspace\\com.cuccumber\\resources\\chromedriver.exe");
	...
	public void enter_Search_criteria() throws InterruptedException {
		driver.findElement(By.xpath("//input[@id='search']")).sendKeys("Amit Kumar");
		Thread.sleep(3000);
	    // Write code here that turns the phrase above into concrete actions
	    //throw new cucumber.api.PendingException();
	}
